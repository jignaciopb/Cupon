...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'cupon', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Cupon/OfertaBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Cupon/CiudadBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Cupon/TiendaBundle/Entity'), 3 => ($this->targetDirs[3].'/src/Cupon/UsuarioBundle/Entity')));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2ad09cc8be1f3d93189945cafc5171cbd3d59c7bbdb9e52cff9be1c840c01914');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'ddc3865a1f5d28dcd2b3f43bcfb7108cf');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('ciudad_por_defecto', 'muskiz');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Cupon/OfertaBundle/Resources/views'), 'Oferta');
        $instance->addPath(($this->targetDirs[3].'/src/Cupon/CiudadBundle/Resources/views'), 'Ciudad');
        $instance->addPath(($this->targetDirs[3].'/src/Cupon/TiendaBundle/Resources/views'), 'Tienda');
        $instance->addPath(($this->targetDirs[3].'/src/Cupon/UsuarioBundle/Resources/views'), 'Usuario');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ddc3865a1f5d28dcd2b3f43bcfb7108cf');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'en',
            'secret' => 'ddc3865a1f5d28dcd2b3f43bcfb7108cf',
            'cupon.ciudad_por_defecto' => 'muskiz',
            ...
            'kernel.secret' => 'ddc3865a1f5d28dcd2b3f43bcfb7108cf',
